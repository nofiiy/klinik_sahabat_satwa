...
// Koneksi ke database
include('../db_connect.php');  // Pastikan pathnya sesuai dengan folder struktur Anda

// Query untuk mendapatkan data dari tabel clinic
$query = "SELECT * FROM clinic";
$result = mysqli_query($conn, $query);

// Cek jika query berhasil
if (!$result) {
    echo "Error fetching clinic data: " . mysqli_error($conn);
    exit;
}
?>
...
<div class="container">
    ...
    <table>
        ...
        <tbody>
            <?php
            // Menampilkan data dari query clinic
